...
class _SPTFRecord(_Dataset):
    ...
    #addition:
    # def on_epoch_end(self): #__exit__(self, exc_type, exc_value, traceback):
    #     self.close()

    # def close(self):
    #     if hasattr(self, '_tfds_iter') and hasattr(self._tfds_iter, '_iterator_resource'):
    #         self._tfds_iter._iterator_resource.close()
    # def on_epoch_end(self):
    #     Release any resources associated with the dataset
    #     You may need to customize this part based on your actual implementation
    #     if hasattr(self, "_tfds_iter"): # and hasattr(self._tfds_iter, "_tf_gen"):
    #         Close the generator if it's available
    #         self._tfds_iter._iterator_resource.close()
    #         del self._tfds_iter
    #         self._tfds_iter._tf_gen.close()
    #         del self._tfds_iter._tf_gen
    #         self._tfds_iter = iter(self._tfds)
