...
class _6IMPOSE(_Dataset):
    ...
    def visualize_example_original(self, example):
        ...
        print(f"mask.shape before gather_nd {mask.shape}")
        print(f"mask[None].shape before gather_nd {mask[None].shape}")
    ...
    def __getitem__(self, idx):
        ...
        if self.if_pose:
            ...
            #pcld_xyz, pcld_index = dpt_2_cld(depth, self.cam_scale, self.intrinsic_matrix, [0, 0])
